...
export type GardenEvents = GameEventTypes & {
  // boardChanged: (board: TicTacToeCell[][]) => void;
  // turnChanged: (isOurTurn: boolean) => void;
};

/**
 * This class is responsible for managing the state of the Garden game, and for sending commands to the server
 */
export default class GardenAreaController extends GameAreaController<
  GardenGameState,
  GardenEvents
> {
